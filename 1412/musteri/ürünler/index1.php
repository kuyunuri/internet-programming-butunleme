...
<button href="index1.php" name="giriş" class="btn btn-primary btn-large btn-block">giriş yap</button>

</div>

</form>
<a href="kayıt1.php"><button  class="btn btn-primary btn-large btn-block">kayıt ol</button></a>
